...
PAGE = os.environ.get("AUDIT_PAGE", "index.html")   # AUDIT_PAGE=cloud.html
...
with sync_playwright() as p:
    ...
    for name,w,h in SIZES:
        ...
        pg.goto(f"http://127.0.0.1:8899/{PAGE}", wait_until="load")
    ...
    b.close()
print(f"\nRESULT [{PAGE}]:", "all clean" if fails==0 else f"{fails} viewport(s) with problems")
